...
$BIN query '{"mode":"bulk-insert","dir":"default","object":"upsert_t","records":[{"key":"k1","value":{"status":"paid","amount":100,"note":"v"}},{"key":"k2","value":{"status":"paid","amount":200,"note":"v"}},{"key":"k3","value":{"status":"pending","amount":50,"note":"v"}}]}' > /dev/null
...
$BIN query '{"mode":"bulk-insert","dir":"default","object":"upsert_t","records":[{"key":"k1","value":{"status":"refunded","amount":100,"note":"v"}}]}' > /dev/null
...
$BIN query '{"mode":"bulk-insert","dir":"default","object":"upsert_t","records":[{"key":"k2","value":{"status":"paid","amount":200,"note":"v"}}]}' > /dev/null
...
$BIN query '{"mode":"bulk-insert","dir":"default","object":"upsert_t","records":[{"key":"k2","value":{"status":"cancelled","amount":999,"note":"v"}}]}' > /dev/null
...
out=$($BIN query '{"mode":"bulk-insert","dir":"default","object":"upsert_t","if_not_exists":true,"records":[{"key":"k1","value":{"status":"paid","amount":1,"note":"v"}}]}')
...
$BIN query '{"mode":"bulk-insert","dir":"default","object":"upsert_t","records":[{"key":"k4","value":{"status":"paid","amount":75,"note":"v"}}]}' > /dev/null
$BIN query '{"mode":"bulk-insert","dir":"default","object":"upsert_t","records":[{"key":"k4","value":{"status":"refunded","amount":75,"note":"v"}}]}' > /dev/null
