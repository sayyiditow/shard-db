...
| `datetime` | `created:datetime` | 7 | `yyyyMMdd` (int32 BE) + seconds-of-day (uint24 BE, 0..86399). Widened from 6 bytes in 2026.09.2; startup migration rewrites old objects. |
